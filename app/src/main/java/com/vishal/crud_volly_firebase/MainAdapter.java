...
holder.email.setText(model.getEmail());
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogPlusBuilder dialogPlusBuilder = DialogPlus.newDialog(holder.img.getContext());
                dialogPlusBuilder.setContentHolder(new ViewHolder(R.layout.popup_update));
                dialogPlusBuilder.setExpanded(true, 1500);
                ...
                EditText surl =view.findViewById(R.id.txtImgUrl);
